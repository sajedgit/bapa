            ...
            <div class="col-sm-12 col-md-12 col-xs-12">
                ...
                <div class="thumbnail" style="border:none; background:white;">
                    ...
                    <div class="col-sm-4 col-md-4 col-xs-12 image-container">
                        <img src="{{ URL::to('/') }}/public/images/{{ $data->event_flyer_location }}"
                             style="margin: 10px;"/>
                    </div>
                    ...
                    <div class="col-sm-5 col-md-5 col-xs-12">
                        ...
                        <p>
                            <span><b>Children Ticket Price: </b>   <?php if ($data->event_ticket_price_children == 0) echo "Free"; else echo $data->event_ticket_price_children; ?></span>
                        </p>
                    ...
                    <div class="col-sm-3 col-md-3 col-xs-12">
                        ...
                        <div class="buy_tickets text-center  <?php if ($data->event_total_seat < 1) echo "disable_class"; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <input type="number" min="0" max="{{ $data->event_total_seat }}" value="1"
                                           name="adult_quantity">
                                    <input type="hidden" min="0" value="{{ $data->event_ticket_price }}"
                                           name="adult_price">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4">
                                    <input type="number" min="0" max="{{ $data->event_total_seat }}" value="0"
                                           name="children_quantity">
                                    <input type="hidden" min="0" value="{{ $data->event_ticket_price_children }}"
                                           name="children_price">
                                </div>
                            </div>
                        ...
                        @if ($data->event_total_seat < 1)
                            <div class="text-center" style="color: red;padding: 10px;">No Tickets Available</div>
                        @endif
