...
$redirect_url=$base_url."sq_payment/after_payment_donate.php";
...
try {
 ...
 // print_r($_REQUEST);die();
       ...
       $donate_price=$_REQUEST['donation']*100;
       ...
       $money_A->setAmount($donate_price);

       $item_A = new OrderLineItem($donate_quantity);
       $item_A->setName($donate_label);
  ...
  $checkout_request->setNote("Donation");
