...
$form_submit_url = $base_url . "after_payment_success_donate";
...
if ($api_response->isSuccess()) {
	...
	if ($api_response->isSuccess()) 
	{
		$result2 = $api_response->getResult();
		$result_data2 = json_encode($result2);
        $result_data2 = json_decode($result_data2);
		$arr["customer_email_address"]=$result_data2->customer->email_address;
		$arr["given_name"]=$result_data2->customer->given_name;
	} 
	else 
	{
